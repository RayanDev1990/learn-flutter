...
Pray prayFromJson(String str) => Pray.fromJson(json.decode(str));

String prayToJson(Pray data) => json.encode(data.toJson());
...
class Pray {
  ...
  factory Pray.fromJson(Map<String, dynamic> json) => Pray(
        code: json["code"],
        status: json["status"],
